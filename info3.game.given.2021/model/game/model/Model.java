...
public class Model {
	...
	public Model(Grid grid, int w, int h, IFactory f) throws IOException {
		...
		m_orientation=new Absolute_Orientation(Absolute_Orientation.SOUTH);
		...
		players[1] = e1;
		Entity e2 = factory.newEntity(this, new Position(600, 200), m_orientation, EntityType.FIREBALL);
		entities.add(e2);
		Entity e3 = factory.newEntity(this, new Position(200, 200), m_orientation, EntityType.TEAMMATE);
		entities.add(e3);
		Entity e4 = factory.newEntity(this, new Position(400, 400), m_orientation, EntityType.BASE);
		entities.add(e4);
		Entity e5 = factory.newEntity(this, new Position(600, 600), m_orientation, EntityType.ITEM);
		entities.add(e5);
